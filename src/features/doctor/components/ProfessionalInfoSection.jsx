    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
      ...
      <div className="bg-[#1C8B8F] px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {autoSaveStatus && (
              <div className={`px-4 py-2 rounded-full backdrop-blur-md border transition-all duration-300 ${autoSaveStatus === 'saving'
            ...
            {onSubmitForReview && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-medium transition-all duration-200 bg-white text-[#1C8B8F] hover:bg-[#F0FDFA] shadow-sm hover:shadow-md"
              >
      ...
      <div className="p-8">
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-8 bg-[#F0FDFA] rounded-lg flex items-center justify-center">
                <svg className="w-4 h-4 text-[#1C8B8F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h4 className="text-lg font-bold text-[#1F2E3C]">المعلومات الأساسية</h4>
            </div>
          ...
          {/* Required Documents */}
          <div className="bg-[#F8FAFC] rounded-2xl p-6 border border-[#E7ECEF]">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-8 bg-[#F0FDFA] rounded-lg flex items-center justify-center">
                <FaFileImage className="w-4 h-4 text-[#1C8B8F]" />
              </div>
