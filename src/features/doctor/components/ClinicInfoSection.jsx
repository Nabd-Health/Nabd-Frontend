      ...
      <div className="bg-[#1C8B8F] px-6 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {autoSaveStatus && (
              <div className={`px-4 py-2 backdrop-blur-sm rounded-lg transition-all ${autoSaveStatus === 'saving' ? 'bg-blue-500/30 text-blue-100' :
      ...
      <div className="p-8 space-y-8">
        ...
        <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#E7ECEF]">
          <div className="flex items-center gap-3 mb-6">
            <FaBuilding className="w-5 h-5 text-[#1C8B8F]" />
            <h4 className="text-lg font-semibold text-[#1F2E3C]">المعلومات الأساسية</h4>
          </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-[#E7ECEF] focus:border-[#1C8B8F] focus:ring-2 focus:ring-[#1C8B8F]/20 rounded-lg transition-all duration-200 text-right"
            />
          </div>
          ...
          <div className="mt-6">
            <div className="flex items-center gap-3 mb-4">
              <FaPhone className="w-4 h-4 text-[#1C8B8F]" />
              <h5 className="font-medium text-[#1F2E3C]">أرقام التواصل</h5>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-[#E7ECEF] focus:border-[#1C8B8F] focus:ring-1 focus:ring-[#1C8B8F]/20 rounded-lg transition-all duration-200 text-left"
                  dir="ltr"
                />
              </div>
          ...
          {/* Services */}
          <div className="mt-6">
            <label className="block text-sm font-semibold text-[#1F2E3C] mb-3 flex items-center gap-2">
              <FaTags className="w-4 h-4 text-[#1C8B8F]" />
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isSelected
                        ? 'bg-[#1C8B8F] text-white border-[#1C8B8F] shadow-lg shadow-[#1C8B8F]/30 scale-[1.02]'
                        : 'bg-white text-[#64748B] border-[#E7ECEF] hover:border-[#1C8B8F] hover:bg-[#F0FDFA]'
                      }
                  ...
                  >
                    {isSelected && (
                      <div className="absolute -top-1 -right-1 w-4 h-4 bg-white rounded-full flex items-center justify-center shadow-md">
                        <FaTags className="w-2 h-2 text-[#1C8B8F]" />
                      </div>
                    )}
            ...
            {selectedServices.length > 0 && (
              <div className="mt-3 p-3 bg-[#F0FDFA] border border-[#1C8B8F]/20 rounded-lg">
                <p className="text-xs text-[#1C8B8F] font-medium flex items-center gap-2">
                  <span className="w-1.5 h-1.5 bg-[#1C8B8F] rounded-full animate-pulse"></span>
        ...
        <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#E7ECEF]">
          <div className="flex items-center gap-3 mb-6">
            <FaMapMarkerAlt className="w-5 h-5 text-[#1C8B8F]" />
            <h4 className="text-lg font-semibold text-[#1F2E3C]">العنوان</h4>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
              ...
              <div>
                <button
                  ...
                  disabled={false}
                  className="w-full px-4 py-2 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 bg-[#1C8B8F] hover:bg-[#14666A] text-white"
        ...
        <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#E7ECEF]">
          <div className="flex items-center gap-3 mb-6">
            <FaCamera className="w-5 h-5 text-[#1C8B8F]" />
            <h4 className="text-lg font-semibold text-[#1F2E3C]">صور العيادة</h4>
            <span className="text-xs text-[#64748B]">(حد أقصى 6 صور)</span>
          </div>
          ...
          <div className="mb-6">
            ...
            <label
              ...
              className={`flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer transition-all duration-200 ${localImages.length >= 6
                ? 'border-[#E7ECEF] bg-[#F1F5F9] cursor-not-allowed'
                : 'border-[#1C8B8F]/30 bg-[#F0FDFA] hover:bg-[#E0F2FE]'
                }`}
            >
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <FaCamera className={`w-8 h-8 mb-2 ${localImages.length >= 6 ? 'text-[#94A3B8]' : 'text-[#1C8B8F]'}`} />
                <p className={`text-sm ${localImages.length >= 6 ? 'text-[#94A3B8]' : 'text-[#1C8B8F]'}`}>
