...
const PartnerSection = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-[#E7ECEF] overflow-hidden">
      {/* Header */}
      <div className="bg-[#1C8B8F] p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">اختر صيدلية و/أو معمل للتعاون معك</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <FaInfoCircle className="text-white/80 text-sm" />
            <span className="text-white/80 text-xs">يمكنك اختيار شريك واحد من كل نوع</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-8">
        ...
        {hasPartner && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            {suggestedPharmacy && (
              <div className="bg-[#F0FDFA] border-2 border-[#1C8B8F]/20 rounded-2xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-[#1C8B8F] rounded-xl flex items-center justify-center">
                      <FaPrescriptionBottle className="text-white text-sm" />
                    </div>
                    <div>
                      <h3 className="text-lg font-black text-[#1F2E3C]">الصيدلية المقترحة</h3>
                      <p className="text-sm text-[#64748B]">شريك حالي</p>
                    </div>
                  </div>
                  <button
            ...
            {suggestedLaboratory && (
              <div className="bg-[#E0F2FE] border-2 border-[#0284C7]/20 rounded-2xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-black text-[#1F2E3C]">المعمل المقترح</h3>
                      <p className="text-sm text-[#64748B]">شريك حالي</p>
                    </div>
                  </div>
                  <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {!suggestedPharmacy && (
              <PartnerAutocomplete
                ...
                gradient="from-[#F8FAFC] to-[#F8FAFC]"
                iconBg="bg-[#1C8B8F]"
